      ...
      <div class="col-md-12">
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                  <form method="post" action="<?php echo base_url('admin/pages/edit/'.$page->id)?>" role="form">
                      ...
                      <div class="form-group">
                          ...
                          <textarea class="form-control summernote" name="details"><?php echo $page->details ?></textarea>
                      </div>
